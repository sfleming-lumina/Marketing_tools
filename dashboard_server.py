...
def build_marketing_funnel_query(
    ...
    return f"""
        ...
        SELECT
            ...
            MAX(cohort_age_days) AS cohortAgeDays,
            MAX(cohort_maturity_bucket) AS cohortMaturityBucket,
            SUM(lead_count) AS leads,
...
def shape_marketing_funnel_row(row):
    ...
    return {
        ...
        "cohortMaturityBucket": row["cohortMaturityBucket"],
        "leads": leads,
        "sets": sets,
        "runs": runs,
        "wins": wins,
...
class DashboardHandler(SimpleHTTPRequestHandler):
    ...
    def end_headers(self):
        ...
        if request_path in ("/", "/marketing_decision_tool.html"):
